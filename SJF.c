...
int main()
{
   ...
   while(burst_count<burst_sum)
   {
       while(count<process)
       {
             ...
             if(burst_count>=arrival[count])
            {
                                      if(check[count]==0)
                                      {
                                                  check[count]=1;
                                                  
                                                  wait_time[count]=burst_count-arrival[count];
                                                  burst_count+=burst[count];
                                                  turnaround_time[count]=burst_count-arrival[count];
                                                  count=0;
